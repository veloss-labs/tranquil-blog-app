...
import useIsomorphicLayoutEffect from "ahooks/es/useIsomorphicLayoutEffect";
...
import { usePortalManager } from "~/context/portal-manager-context";
...
const Container: React.FC<{ zIndex: number; children: React.ReactNode }> = (
  ...
  <div
    className="next-headless-portal-zIndex"
    style={{
      position: "absolute",
      zIndex: props.zIndex,
      top: 0,
